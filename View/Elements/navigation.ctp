...
<li class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-user">
        <?php if(!$this->Session->check('Auth.User')):?>
            <li><?php echo $this->Html->link(__('Login'),array('plugin'=>null,'controller'=>'MyUsers','action'=>'login'))?></li>
        <?php else: ?>
        ...
        <li class="divider"></li>
        <li><?php
                $text = '<i class="fa fa-sign-out fa-fw"></i>'.__('Logout');
                echo $this->Html->link(__('Logout'), array('plugin'=>null,'controller'=>'MyUsers', 'action'=>'logout'))
            ?>
        </li>
        <?php endif;?>
    </ul>
